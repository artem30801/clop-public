...
if (date("I")) {
$timer = 3600 - (date("U") - 3600) % 3600; # tick timer in seconds
} else {
$timer = 3600 - date("U") % 3600; # tick timer in seconds
}
...
<center>Discuss &gt;CLOP on the <a href="https://boards.4channel.org/mlp/thread/39608516#p39653466" target="_new_win">MLP thread</a> and the <a href="https://discord.gg/TbmQ5R4zJn" target="_new_win">Discord</a> | Vote for tick length: <a href="https://strawpoll.com/polls/ajnEO1WjMZW" target="_new_win">Poll</a> | War tick timing is changing. See the thread on /MLP/</center>
EOFORM;
if ($errors) {
